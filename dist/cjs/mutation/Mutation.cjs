...
const HttpClient = require("../http/HttpClient.cjs");
...
class Mutation {
  constructor(pathname, schema) {
    ...
    this.http = HttpClient.HttpClient.getInstance();
    this.pathname = pathname;
    this.schema = schema;
    this.relation = Builder.Builder.getRelationBuilder();
  }
  entityBuilder() {
    const builder = Builder.Builder.createEntityBuilder(this.relation);
