...
export type CreateValidRelationOperation = CreateRelationOperation<Attributes> | AttachRelationDefinition;
export type UpdateValidRelationOperation = CreateRelationOperation<Attributes> | UpdateRelationOperation<Attributes> | AttachRelationDefinition | DetachRelationDefinition | SyncRelationDefinition<Attributes> | ToggleRelationDefinition<Attributes>;
export type CreateRelationParams<T extends Attributes, TRelationKey extends keyof T = never> = {
    attributes: T;
    relations?: Record<TRelationKey, CreateValidRelationOperation>;
};
export type UpdateRelationParams<T extends Attributes, TRelationKey extends keyof T = never> = {
    key: SimpleKey;
    attributes: T;
...
export type TypedMutationOperation<TModel, TRelations = Record<string, unknown>> = {
...
export interface MutationFunction<T> {
    (data: MutationRequest<T, Record<string, unknown>>, options?: Partial<RequestConfig>): Promise<MutationResponse>;
}
...
export interface IModel<TModel> {
    create<T extends Record<string, unknown>, TRelationKeys extends keyof T = never>(params: {
        attributes: T;
        relations?: StrictCreateRelationsMap<Record<Extract<TRelationKeys, string>, unknown>>;
    }): BuilderWithCreationContext<TModel>;
    update<T extends Record<string, unknown>, TRelationKeys extends keyof T = never>(key: SimpleKey, params: {
        attributes?: T;
        relations?: StrictUpdateRelationsMap<Record<Extract<TRelationKeys, string>, unknown>>;
    }): BuilderWithUpdateContext<TModel>;
    setMutationFunction: (cb: MutationFunction<TModel>) => void;
}
export interface IMutation<T> {
    model: IModel<T>;
    mutate: (mutateRequest: BuilderWithCreationContext<T> | BuilderWithUpdateContext<T> | MutationRequest<T, Record<string, unknown>>, options?: Partial<RequestConfig>) => Promise<MutationResponse>;
    action: (actionRequest: ActionRequest, options?: Partial<RequestConfig>) => Promise<ActionResponse>;
