  ...
  implements IEntityBuilder<TModel>, BuildOnly<TModel>
{
  ...
  >(
    ...
    import("./types/mutation.js").CreateRelationOperation<T> & {
      relations?:
        | Record<TRelationKeys, ValidCreateNestedRelation<unknown>>
        | undefined;
    };
  updateRelation<
    T extends Record<string, unknown>,
  ...
  >(
    ...
    import("./types/mutation.js").UpdateRelationOperation<T> & {
      relations?:
        | Record<TRelationKeys, ValidUpdateNestedRelation<unknown>>
        | undefined;
    };
  attach(
    key: string | number,
  ): import("./types/mutation.js").AttachRelationDefinition;
  detach(
    key: string | number,
  ): import("./types/mutation.js").DetachRelationDefinition;
  sync<T>(
    key: string | number | Array<string | number>,
    attributes?: T,
    pivot?: Record<string, string | number>,
    withoutDetaching?: boolean,
  ): import("./types/mutation.js").SyncRelationDefinition<T>;
  toggle<T>(
    key: string | number | Array<string | number>,
    attributes?: T,
    pivot?: Record<string, string | number>,
  ): import("./types/mutation.js").ToggleRelationDefinition<T>;
}
