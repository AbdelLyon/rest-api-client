...
export type AggregationFunction = "min" | "max" | "avg" | "sum" | "count" | "exists";
export type SearchPermission = "create" | "view" | "update" | "delete" | "restore" | "forceDelete";
...
export interface IQuery<T> {
    search: <TResponse = Array<T>>(search: SearchRequest | PaginatedSearchRequest, options: Partial<RequestConfig>) => Promise<TResponse>;
