...
export type RelationDefinition<T = unknown, InCreateContext extends boolean = false> = InCreateContext extends true ? ValidCreateNestedRelation<T> : ValidUpdateNestedRelation<T>;
