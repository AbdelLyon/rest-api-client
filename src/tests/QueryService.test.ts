...
// import { QueryTestService } from "./services/QueryTestService";
...
//   let queryService: QueryTestService;
//   let mockAxiosInstance: Partial<AxiosInstance>;

//   beforeEach(() => {
//     vi.clearAllMocks();
//     QueryTestService.resetInstance();
//     queryService = QueryTestService.getInstance("users");
...
//       const instance1 = QueryTestService.getInstance("users");
//       const instance2 = QueryTestService.getInstance("users");
...
//       QueryTestService.resetInstance();
//       const instance1 = QueryTestService.getInstance("users");
//       const instance2 = QueryTestService.getInstance("users2");
